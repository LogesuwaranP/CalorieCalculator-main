...
const Display = () => {
  ...
  const [i, setI] = useState(
    "https://images.pexels.com/photos/5842227/pexels-photo-5842227.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
  );
        ...
        {data
          ...
          .map((item) => (
            <li
              key={item.id}
              onClick={() => {
                add(item.calorie, item.food_name, item.image);
              }}
            >
              {item.food_name}
            </li>
